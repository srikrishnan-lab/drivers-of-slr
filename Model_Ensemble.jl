...
sea_level_rise = getdataframe(SNEASY_BRICK, :global_sea_level=>:sea_level_rise)
print(sea_level_rise) # total sea level rise from all components (m) (includes landwater storage for projection periods)
...
yrs = 2050:5:2200
plt = areaplot(yrs, Matrix(shap_permute[!, Not(:group)]), label=permutedims(shap_norm.group), xlabel="Year", ylabel="Normalized Grouped Shapley Index", color_palette=:seaborn_colorblind, left_margin=5mm, right_margin=5mm, legendfontsize=6, guidefontsize=6, tickfontsize=5)
Plots.xticks!(plt, 2050:25:2200)
Plots.xlims!((2050, 2200))
Plots.ylims!((0, 1))
Plots.plot!(size=(350, 300))

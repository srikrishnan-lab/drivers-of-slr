...
function rcp_dfs(rcp_scenario) # generate df with relevant information for each RCP scenario
...
df_RCP26 = rcp_dfs("RCP26")
df_RCP45 = rcp_dfs("RCP45")
df_RCP60 = rcp_dfs("RCP60")
df_RCP85 = rcp_dfs("RCP85")
...
emissions_plot = plot(years, all_rcp_co2_emissions, label = labels, title = "rcp_co2_emissions", xlabel = "year", ylabel = "rcp_co2_emissions")
...
n2o_plot = plot(years, all_rcp_n2o_concentration, label = labels, legend = :topleft, title = "rcp_n2o_concentration", xlabel = "year", ylabel = "rcp_n2o_concentration")
...
aerosol_plot = plot(years, all_rcp_aerosol_forcing, label = labels, title = "rcp_aerosol_forcing", xlabel = "year", ylabel = "rcp_aerosol_forcing")
...
other_forcing_plot = plot(years, all_rcp_other_forcing, label = labels, legend = :topleft, title = "rcp_other_forcing", xlabel = "year", ylabel = "rcp_other_forcing")
...
rf_plot = plot(years, rf_scenarios, label = labels, legend = :topleft, title = "Forcing Values for Two Scenarios", xlabel = "year", ylabel = "forcing")
display(rf_plot)